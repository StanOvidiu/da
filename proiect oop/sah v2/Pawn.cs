...
namespace sah_v2
{
    class Pawn : Piece
    {
        public const string bPawn = "C:/Users/stano/OneDrive/Desktop/New folder/Chess_pdt60.png";
        public const string wPawn = "C:/Users/stano/OneDrive/Desktop/New folder/Chess_plt60.png";
        ...
        public override void Move(object sender, EventArgs args)         
        {
            ...
            if (button.Image == Image.FromFile(bPawn))
                GetAvailableMovesBlackPawn();
            if (button.Image == Image.FromFile(wPawn))
